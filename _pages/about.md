...
---
Hi, I’m Kian. I am a Bioinformatics Scientist at [Watchmaker Genomics](https://www.watchmakergenomics.com/), specializing in the development of [novel NGS secondary analysis algorithms](https://github.com/watchmaker-genomics/TVC) for germline and somatic variant detection, with a focus on oncology applications. I design statistically rigorous tools for ultra-low allele frequency variant detection and build production-grade pipelines that translate research algorithms into clinically relevant tools. I also contribute to large-scale, production Nextflow pipelines and perform ad hoc analysis for wet lab scientists.
